...
```{r, echo=T}
# long to wide
dt.wide1 <- dcast(dt.long, EXMD_BZ_YYYY + RN_INDI + HGHT + WGHT ~ measure, value.var = "val")
dt.wide1
```
...
dt.wide2 <- dcast(dt.long, EXMD_BZ_YYYY ~ measure, value.var = "val", fun.aggregate = mean, na.rm =T)
dt.wide2
```
